...
* TODO RELEASE 0.8
** TODO joystick support off by default, use control-J to activate
** TODO [#A] ENDING
** TODO [#A] BOSS: Algorithmically generated compile-shmup multi eye base final boss
*** TODO [#C] import bomb code from xalcyon
** TODO [#A] HELP SCREEN
...
** TODO [#A] Fix some mice and other devices registering as useless joysticks (turn on joystick with Control-J)
** TODO [#A] libsdl_gfx, can it be un-required?
