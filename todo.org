...
* TODO RELEASE 0.95
** TODO improve diagonal firing w/joystick? 
** TODO never have red box with red gate
** TODO proximity crowding beep alarm? 
** TODO show gate dir indicator for a bit longer/larger
** TODO ball should not get stuck on thief corpse
** TODO fix character jitter during scrolling
** TODO eliminate image loading stutter by pre-drawing all objects once with loading screen shown on top of that
...
** TODO [#B] implement LOS for ball targeting. just run a line of x/y points in between 
** TODO [#B] display message when paused
** TODO shoudl have to defeat all boss enemies to progress
** TODO [#A] BOSS: Algorithmically generated compile-shmup Kobodeluxe multi eye base final boss with gray bricks
*** TODO things that fire vertical and horizontal bullets, and can only be destroyed from corners
**** TODO these replace gas vents in low-level garrisons
*** TODO brains inside gates on boss level
** TODO play all the way through and take notes on each level

* TODO Release 1.0 "beta"
** TODO disable mouse and terminal view
